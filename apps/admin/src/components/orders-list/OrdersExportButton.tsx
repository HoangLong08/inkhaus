...
/**
 * The most rows one export carries - the API's `ORDER_EXPORT_MAX`
 * (apps/api/src/modules/orders/admin-order-export.csv.ts). Repeated here only
 * to warn before the download; the API enforces it either way.
 */
 ...
 * orders match than a file holds this says so beside the button, from the
 * total the page already has.
 */
